 ...
 */
package com.letattung.fluentinterface;
...
import com.letattung.fluentinterface.lazy.LazyFluentIterable;
import com.letattung.fluentinterface.simple.SimpleFluentIterable;
...
public class App {
	...
	public static void main(String [] args){
		...
		SimpleFluentIterable.fromCopyOf(integerList).filter(number -> number % 2 == 0)
		.first().ifPresent(evenNumber -> LOGGER.info("The first even number is: {}", evenNumber));
