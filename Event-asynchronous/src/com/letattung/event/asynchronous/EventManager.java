...
public class EventManager implements ThreadCompleteListener{
	...
	public int create(int eventTime) throws InvalidOperationException, LongRunningEventException, MaxNumOfEventsAllowedException{
	...
	private int generateId(){
		...
		while (eventPool.containsKey(randomNum)){
			randomNum = random.nextInt((MAX_ID - MIN_ID) + 1) + MIN_ID;
		}
		return randomNum;
	}
